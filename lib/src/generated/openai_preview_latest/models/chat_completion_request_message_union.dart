...
@MappableClass(includeSubClasses: [ChatCompletionRequestMessageUnionChatCompletionRequestDeveloperMessage, ChatCompletionRequestMessageUnionChatCompletionRequestSystemMessage, ChatCompletionRequestMessageUnionChatCompletionRequestUserMessage, ChatCompletionRequestMessageUnionChatCompletionRequestAssistantMessage, ChatCompletionRequestMessageUnionChatCompletionRequestToolMessage, ChatCompletionRequestMessageUnionChatCompletionRequestFunctionMessage])
...
extension ChatCompletionRequestMessageUnionDeserializer on ChatCompletionRequestMessageUnion {
  static ChatCompletionRequestMessageUnion tryDeserialize(Map<String, dynamic> json) {
    try {
      return ChatCompletionRequestMessageUnionChatCompletionRequestDeveloperMessageMapper.fromJson(json);
    } catch (_) {}
    try {
...
@MappableClass()
class ChatCompletionRequestMessageUnionChatCompletionRequestDeveloperMessage extends ChatCompletionRequestMessageUnion with ChatCompletionRequestMessageUnionChatCompletionRequestDeveloperMessageMappable {
  final String content;
  final ChatCompletionRequestDeveloperMessageRoleRole role;
  final String? name;

  const ChatCompletionRequestMessageUnionChatCompletionRequestDeveloperMessage({
...
class ChatCompletionRequestMessageUnionChatCompletionRequestAssistantMessage extends ChatCompletionRequestMessageUnion with ChatCompletionRequestMessageUnionChatCompletionRequestAssistantMessageMappable {
  ...
  const ChatCompletionRequestMessageUnionChatCompletionRequestAssistantMessage({
    ...
    required this.role,
    required this.name,
    required this.chatCompletionRequestAssistantMessageAudio,
