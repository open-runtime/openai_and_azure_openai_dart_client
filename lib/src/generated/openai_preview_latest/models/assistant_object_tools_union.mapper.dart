...
class AssistantObjectToolsUnionFileSearchMapper
  ...
  _$assistantToolsFileSearchFileSearch(AssistantObjectToolsUnionFileSearch v) =>
  ...
  static AssistantObjectToolsUnionFileSearch _instantiate(DecodingData data) {
    return AssistantObjectToolsUnionFileSearch(
...
class AssistantObjectToolsUnionFunctionMapper
  ...
  >
  _f$type = Field('type', _$type);
  static FunctionObject _$functionField(AssistantObjectToolsUnionFunction v) =>
      v.functionField;
  static const Field<AssistantObjectToolsUnionFunction, FunctionObject>
