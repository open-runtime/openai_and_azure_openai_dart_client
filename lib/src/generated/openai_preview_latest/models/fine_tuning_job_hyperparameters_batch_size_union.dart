...
extension FineTuningJobHyperparametersBatchSizeUnionDeserializer on FineTuningJobHyperparametersBatchSizeUnion {
  static FineTuningJobHyperparametersBatchSizeUnion tryDeserialize(dynamic json) {
    ...
    throw FormatException(
      'Could not determine the correct type for FineTuningJobHyperparametersBatchSizeUnion from: $json',
    );
  }
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class FineTuningJobHyperparametersBatchSizeUnionVariantString extends FineTuningJobHyperparametersBatchSizeUnion
    with FineTuningJobHyperparametersBatchSizeUnionVariantStringMappable {
  final String value;

  const FineTuningJobHyperparametersBatchSizeUnionVariantString({required this.value});
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class FineTuningJobHyperparametersBatchSizeUnionVariantInt extends FineTuningJobHyperparametersBatchSizeUnion
    with FineTuningJobHyperparametersBatchSizeUnionVariantIntMappable {
  final int value;

  const FineTuningJobHyperparametersBatchSizeUnionVariantInt({required this.value});
}
