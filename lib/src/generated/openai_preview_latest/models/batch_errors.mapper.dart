...
class BatchErrorsMapper extends ClassMapperBase<BatchErrors> {
  ...
  static List<BatchErrorsData>? _$data(BatchErrors v) => v.data;
  static const Field<BatchErrors, List<BatchErrorsData>> _f$data = Field(
    'data',
    _$data,
    opt: true,
  );
...
abstract class BatchErrorsCopyWith<$R, $In extends BatchErrors, $Out>
  ...
  ListCopyWith<
    $R,
    BatchErrorsData,
    BatchErrorsDataCopyWith<$R, BatchErrorsData, BatchErrorsData>
  >?
  get data;
  $R call({String? objectField, List<BatchErrorsData>? data});
