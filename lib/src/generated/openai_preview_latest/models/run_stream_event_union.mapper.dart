...
class RunStreamEventUnionMapper extends ClassMapperBase<RunStreamEventUnion> {
  ...
  static RunStreamEventUnionMapper ensureInitialized() {
    if (_instance == null) {
      ...
      RunStreamEventUnionVariant10Mapper.ensureInitialized();
    }
    return _instance!;
  }
...
class RunStreamEventUnionVariant10Mapper
    extends ClassMapperBase<RunStreamEventUnionVariant10> {
  RunStreamEventUnionVariant10Mapper._();

  static RunStreamEventUnionVariant10Mapper? _instance;
  static RunStreamEventUnionVariant10Mapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = RunStreamEventUnionVariant10Mapper._(),
      );
      RunStreamEventUnionMapper.ensureInitialized();
  ...
  @override
  final String id = 'RunStreamEventUnionVariant10';

  static RunStreamEventUnionVariant10EventEvent _$event(
    RunStreamEventUnionVariant10 v,
  ) => v.event;
  static const Field<
    RunStreamEventUnionVariant10,
    RunStreamEventUnionVariant10EventEvent
  >
  _f$event = Field('event', _$event);
  static RunObject _$data(RunStreamEventUnionVariant10 v) => v.data;
  static const Field<RunStreamEventUnionVariant10, RunObject> _f$data = Field(
    'data',
    _$data,
  );

  @override
  final MappableFields<RunStreamEventUnionVariant10> fields = const {
    #event: _f$event,
    #data: _f$data,
  };
  ...
  static RunStreamEventUnionVariant10 fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<RunStreamEventUnionVariant10>(map);
  }

  static RunStreamEventUnionVariant10 fromJsonString(String json) {
    return ensureInitialized().decodeJson<RunStreamEventUnionVariant10>(json);
  }
}

mixin RunStreamEventUnionVariant10Mappable {
  String toJsonString() {
    return RunStreamEventUnionVariant10Mapper.ensureInitialized()
        .encodeJson<RunStreamEventUnionVariant10>(
          this as RunStreamEventUnionVariant10,
        );
  }

  Map<String, dynamic> toJson() {
    return RunStreamEventUnionVariant10Mapper.ensureInitialized()
        .encodeMap<RunStreamEventUnionVariant10>(
          this as RunStreamEventUnionVariant10,
        );
  }

  RunStreamEventUnionVariant10CopyWith<
    RunStreamEventUnionVariant10,
    RunStreamEventUnionVariant10,
    RunStreamEventUnionVariant10
  >
  get copyWith =>
      _RunStreamEventUnionVariant10CopyWithImpl<
        RunStreamEventUnionVariant10,
        RunStreamEventUnionVariant10
      >(this as RunStreamEventUnionVariant10, $identity, $identity);
  @override
  String toString() {
    return RunStreamEventUnionVariant10Mapper.ensureInitialized()
        .stringifyValue(this as RunStreamEventUnionVariant10);
  }

  @override
  bool operator ==(Object other) {
    return RunStreamEventUnionVariant10Mapper.ensureInitialized().equalsValue(
      this as RunStreamEventUnionVariant10,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return RunStreamEventUnionVariant10Mapper.ensureInitialized().hashValue(
      this as RunStreamEventUnionVariant10,
    );
  }
}

extension RunStreamEventUnionVariant10ValueCopy<$R, $Out>
    on ObjectCopyWith<$R, RunStreamEventUnionVariant10, $Out> {
  RunStreamEventUnionVariant10CopyWith<$R, RunStreamEventUnionVariant10, $Out>
  get $asRunStreamEventUnionVariant10 => $base.as(
    (v, t, t2) => _RunStreamEventUnionVariant10CopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class RunStreamEventUnionVariant10CopyWith<
  $R,
  $In extends RunStreamEventUnionVariant10,
  $Out
>
    implements RunStreamEventUnionCopyWith<$R, $In, $Out> {
  RunObjectCopyWith<$R, RunObject, RunObject> get data;
  @override
  $R call({RunStreamEventUnionVariant10EventEvent? event, RunObject? data});
  RunStreamEventUnionVariant10CopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  );
}

class _RunStreamEventUnionVariant10CopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, RunStreamEventUnionVariant10, $Out>
    implements
        RunStreamEventUnionVariant10CopyWith<
          $R,
          RunStreamEventUnionVariant10,
  ...
  @override
  late final ClassMapperBase<RunStreamEventUnionVariant10> $mapper =
      RunStreamEventUnionVariant10Mapper.ensureInitialized();
  @override
  RunObjectCopyWith<$R, RunObject, RunObject> get data =>
      $value.data.copyWith.$chain((v) => call(data: v));
  ...
  @override
  RunStreamEventUnionVariant10 $make(CopyWithData data) =>
      RunStreamEventUnionVariant10(
        event: data.get(#event, or: $value.event),
        data: data.get(#data, or: $value.data),
      );
  ...
  @override
  RunStreamEventUnionVariant10CopyWith<$R2, RunStreamEventUnionVariant10, $Out2>
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _RunStreamEventUnionVariant10CopyWithImpl<$R2, $Out2>($value, $cast, t);
}
