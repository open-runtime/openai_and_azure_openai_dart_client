...
class RealtimeTranscriptionSessionCreateResponseMapper
  ...
  _$realtimeTranscriptionSessionCreateResponseInputAudioTranscription(
    RealtimeTranscriptionSessionCreateResponse v,
  ) => v.realtimeTranscriptionSessionCreateResponseInputAudioTranscription;
  static const Field<
    RealtimeTranscriptionSessionCreateResponse,
  ...
  @override
  final MappableFields<RealtimeTranscriptionSessionCreateResponse>
  fields = const {
    #realtimeTranscriptionSessionCreateResponseClientSecret:
    ...
    #realtimeTranscriptionSessionCreateResponseInputAudioTranscription:
        _f$realtimeTranscriptionSessionCreateResponseInputAudioTranscription,
    #realtimeTranscriptionSessionCreateResponseTurnDetection:
  ...
  static RealtimeTranscriptionSessionCreateResponse _instantiate(
    ...
    return RealtimeTranscriptionSessionCreateResponse(
      ...
      realtimeTranscriptionSessionCreateResponseInputAudioTranscription: data
          .dec(
            _f$realtimeTranscriptionSessionCreateResponseInputAudioTranscription,
          ),
...
>
  ...
  RealtimeTranscriptionSessionCreateResponseInputAudioTranscriptionCopyWith<
    ...
    RealtimeTranscriptionSessionCreateResponseInputAudioTranscription
  >?
  get realtimeTranscriptionSessionCreateResponseInputAudioTranscription;
...
class _RealtimeTranscriptionSessionCreateResponseCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    Object? realtimeTranscriptionSessionCreateResponseInputAudioTranscription =
        $none,
    ...
    FieldCopyWithData({
      ...
      if (realtimeTranscriptionSessionCreateResponseInputAudioTranscription !=
          $none)
        #realtimeTranscriptionSessionCreateResponseInputAudioTranscription:
            realtimeTranscriptionSessionCreateResponseInputAudioTranscription,
  ...
  @override
  RealtimeTranscriptionSessionCreateResponse $make(
    CopyWithData data,
  ) => RealtimeTranscriptionSessionCreateResponse(
    ...
    realtimeTranscriptionSessionCreateResponseInputAudioTranscription: data.get(
      #realtimeTranscriptionSessionCreateResponseInputAudioTranscription,
      or: $value
          .realtimeTranscriptionSessionCreateResponseInputAudioTranscription,
    ),
