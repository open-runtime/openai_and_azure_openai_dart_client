...
class ChatCompletionRequestUserMessageContentPartUnionMapper
  ...
  ensureInitialized() {
    if (_instance == null) {
      ...
      ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMapper
    extends
        ClassMapperBase<
          ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile
        > {
  ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMapper._();

  static ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMapper?
  _instance;
  static ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMapper
  ensureInitialized() {
    if (_instance == null) {
  ...
  static ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile
  _instantiate(DecodingData data) {
    return ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile(
      type: data.dec(_f$type),
...
mixin ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMappable {
  String toJsonString() {
    return ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMapper.ensureInitialized()
        .encodeJson<
          ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile
        >(
          this
              as ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile,
        );
  }
  ...
  ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileCopyWith<
    ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile,
    ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile,
    ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile
  >
  get copyWith =>
      _ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileCopyWithImpl<
        ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile,
        ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile
      >(
        this
...
extension ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileValueCopy<
  $R,
  $Out
>
    on
  ...
  ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileCopyWith<
    ...
    $Out
  >
  get $asChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile =>
      $base.as(
        (v, t, t2) =>
            _ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileCopyWithImpl<
              $R,
...
abstract class ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileCopyWith<
  $R,
  $In extends ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile,
  $Out
>
    implements
        ChatCompletionRequestUserMessageContentPartUnionCopyWith<
...
class _ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileCopyWithImpl<
  $R,
  $Out
>
    extends
