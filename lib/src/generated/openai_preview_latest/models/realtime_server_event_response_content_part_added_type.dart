...
enum RealtimeServerEventResponseContentPartAddedType {
  ...
  static List<RealtimeServerEventResponseContentPartAddedType> get $valuesDefined =>
      values.where((value) => value != RealtimeServerEventResponseContentPartAddedType.unknown).toList();
}
