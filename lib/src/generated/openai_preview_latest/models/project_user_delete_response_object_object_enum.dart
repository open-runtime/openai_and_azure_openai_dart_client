...
enum ProjectUserDeleteResponseObjectObjectEnum {
  ...
  static List<ProjectUserDeleteResponseObjectObjectEnum> get $valuesDefined =>
      values.where((value) => value != ProjectUserDeleteResponseObjectObjectEnum.unknown).toList();
}
