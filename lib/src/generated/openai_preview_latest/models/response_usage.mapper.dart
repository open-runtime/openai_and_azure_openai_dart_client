...
class ResponseUsageMapper extends ClassMapperBase<ResponseUsage> {
  ...
  static ResponseUsageInputTokensDetails _$responseUsageInputTokensDetails(
    ResponseUsage v,
  ) => v.responseUsageInputTokensDetails;
  static const Field<ResponseUsage, ResponseUsageInputTokensDetails>
  ...
  final MappableFields<ResponseUsage> fields = const {
    ...
    #responseUsageInputTokensDetails: _f$responseUsageInputTokensDetails,
  ...
  static ResponseUsage _instantiate(DecodingData data) {
    return ResponseUsage(
      ...
      responseUsageInputTokensDetails: data.dec(
        _f$responseUsageInputTokensDetails,
      ),
...
abstract class ResponseUsageCopyWith<$R, $In extends ResponseUsage, $Out>
  ...
  ResponseUsageInputTokensDetailsCopyWith<
    ...
    ResponseUsageInputTokensDetails
  >
  get responseUsageInputTokensDetails;
  ...
  $R call({
    int? inputTokens,
    ResponseUsageInputTokensDetails? responseUsageInputTokensDetails,
    int? outputTokens,
...
class _ResponseUsageCopyWithImpl<$R, $Out>
  ...
  ResponseUsageInputTokensDetailsCopyWith<
    ...
    ResponseUsageInputTokensDetails
  >
  get responseUsageInputTokensDetails => $value
      .responseUsageInputTokensDetails
      .copyWith
      .$chain((v) => call(responseUsageInputTokensDetails: v));
  @override
  ResponseUsageOutputTokensDetailsCopyWith<
    $R,
    ResponseUsageOutputTokensDetails,
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (responseUsageInputTokensDetails != null)
        #responseUsageInputTokensDetails: responseUsageInputTokensDetails,
  ...
  ResponseUsage $make(CopyWithData data) => ResponseUsage(
    ...
    responseUsageInputTokensDetails: data.get(
      #responseUsageInputTokensDetails,
      or: $value.responseUsageInputTokensDetails,
    ),
