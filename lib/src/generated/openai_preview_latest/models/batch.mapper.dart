...
class BatchMapper extends ClassMapperBase<Batch> {
  ...
  static BatchRequestCounts? _$batchRequestCounts(Batch v) =>
      v.batchRequestCounts;
  static const Field<Batch, BatchRequestCounts> _f$batchRequestCounts = Field(
    'batchRequestCounts',
    _$batchRequestCounts,
    key: r'BatchRequestCounts',
    opt: true,
  );
  ...
  final MappableFields<Batch> fields = const {
    ...
    #batchRequestCounts: _f$batchRequestCounts,
  ...
  static Batch _instantiate(DecodingData data) {
    return Batch(
      ...
      batchRequestCounts: data.dec(_f$batchRequestCounts),
...
class _BatchCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Batch, $Out>
  ...
  @override
  BatchRequestCountsCopyWith<$R, BatchRequestCounts, BatchRequestCounts>?
  get batchRequestCounts => $value.batchRequestCounts?.copyWith.$chain(
    (v) => call(batchRequestCounts: v),
  );
  @override
  MapCopyWith<$R, String, String, ObjectCopyWith<$R, String, String>>?
  ...
  $R call({
    ...
    Object? batchRequestCounts = $none,
    ...
    FieldCopyWithData({
      ...
      if (batchRequestCounts != $none) #batchRequestCounts: batchRequestCounts,
  ...
  Batch $make(CopyWithData data) => Batch(
    ...
    batchRequestCounts: data.get(
      #batchRequestCounts,
      or: $value.batchRequestCounts,
    ),
