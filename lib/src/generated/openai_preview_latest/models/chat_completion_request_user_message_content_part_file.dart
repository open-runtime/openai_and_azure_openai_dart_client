...
class ChatCompletionRequestUserMessageContentPartFile with ChatCompletionRequestUserMessageContentPartFileMappable {
  ...
  static ChatCompletionRequestUserMessageContentPartFile fromJson(Map<String, dynamic> json) => ChatCompletionRequestUserMessageContentPartFileMapper.fromJson(json);
