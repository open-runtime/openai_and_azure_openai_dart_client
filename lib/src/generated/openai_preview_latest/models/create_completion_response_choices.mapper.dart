...
class CreateCompletionResponseChoicesMapper
  ...
  static CreateCompletionResponseChoicesLogprobs?
  _$createCompletionResponseChoicesLogprobs(
    CreateCompletionResponseChoices v,
  ) => v.createCompletionResponseChoicesLogprobs;
  static const Field<
    CreateCompletionResponseChoices,
  ...
  static CreateCompletionResponseChoices _instantiate(DecodingData data) {
    return CreateCompletionResponseChoices(
      ...
      createCompletionResponseChoicesLogprobs: data.dec(
        _f$createCompletionResponseChoicesLogprobs,
      ),
...
>
  ...
  CreateCompletionResponseChoicesLogprobsCopyWith<
    ...
    CreateCompletionResponseChoicesLogprobs
  >?
  get createCompletionResponseChoicesLogprobs;
  $R call({
...
class _CreateCompletionResponseChoicesCopyWithImpl<$R, $Out>
  ...
  CreateCompletionResponseChoicesLogprobsCopyWith<
    ...
    CreateCompletionResponseChoicesLogprobs
  >?
  get createCompletionResponseChoicesLogprobs => $value
      .createCompletionResponseChoicesLogprobs
      ?.copyWith
      .$chain((v) => call(createCompletionResponseChoicesLogprobs: v));
  @override
  $R call({
    CreateCompletionResponseChoicesFinishReasonFinishReason? finishReason,
    int? indexField,
    Object? createCompletionResponseChoicesLogprobs = $none,
    String? text,
  }) => $apply(
    FieldCopyWithData({
      if (finishReason != null) #finishReason: finishReason,
      if (indexField != null) #indexField: indexField,
      if (createCompletionResponseChoicesLogprobs != $none)
        #createCompletionResponseChoicesLogprobs:
            createCompletionResponseChoicesLogprobs,
  ...
  CreateCompletionResponseChoices $make(CopyWithData data) =>
      CreateCompletionResponseChoices(
        ...
        createCompletionResponseChoicesLogprobs: data.get(
          #createCompletionResponseChoicesLogprobs,
          or: $value.createCompletionResponseChoicesLogprobs,
        ),
