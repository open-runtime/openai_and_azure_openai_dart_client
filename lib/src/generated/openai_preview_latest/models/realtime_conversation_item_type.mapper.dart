...
class RealtimeConversationItemTypeMapper
  ...
  RealtimeConversationItemType decode(dynamic value) {
    switch (value) {
      ...
      case 'function_call':
        return RealtimeConversationItemType.functionCall;
      case 'function_call_output':
        return RealtimeConversationItemType.functionCallOutput;
      case 'unknown':
  ...
  dynamic encode(RealtimeConversationItemType self) {
    switch (self) {
      case RealtimeConversationItemType.message:
        return 'message';
      case RealtimeConversationItemType.functionCall:
        return 'function_call';
      case RealtimeConversationItemType.functionCallOutput:
