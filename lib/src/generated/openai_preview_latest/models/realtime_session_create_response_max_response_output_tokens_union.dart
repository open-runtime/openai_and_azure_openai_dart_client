...
sealed class RealtimeSessionCreateResponseMaxResponseOutputTokensUnion
    with RealtimeSessionCreateResponseMaxResponseOutputTokensUnionMappable {
...
extension RealtimeSessionCreateResponseMaxResponseOutputTokensUnionDeserializer
    on RealtimeSessionCreateResponseMaxResponseOutputTokensUnion {
  static RealtimeSessionCreateResponseMaxResponseOutputTokensUnion tryDeserialize(dynamic json) {
    ...
    throw FormatException(
      'Could not determine the correct type for RealtimeSessionCreateResponseMaxResponseOutputTokensUnion from: $json',
    );
  }
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class RealtimeSessionCreateResponseMaxResponseOutputTokensUnionVariantString
    extends RealtimeSessionCreateResponseMaxResponseOutputTokensUnion
    with RealtimeSessionCreateResponseMaxResponseOutputTokensUnionVariantStringMappable {
  final String value;

  const RealtimeSessionCreateResponseMaxResponseOutputTokensUnionVariantString({required this.value});
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class RealtimeSessionCreateResponseMaxResponseOutputTokensUnionVariantInt
    extends RealtimeSessionCreateResponseMaxResponseOutputTokensUnion
    with RealtimeSessionCreateResponseMaxResponseOutputTokensUnionVariantIntMappable {
  final int value;

  const RealtimeSessionCreateResponseMaxResponseOutputTokensUnionVariantInt({required this.value});
}

/// Extension to get raw value for JSON serialization of primitive unions.
/// Use this instead of toJson() when serializing to API requests.
extension RealtimeSessionCreateResponseMaxResponseOutputTokensUnionJsonValue
    on RealtimeSessionCreateResponseMaxResponseOutputTokensUnion {
...
class RealtimeSessionCreateResponseMaxResponseOutputTokensUnionHook extends MappingHook {
  ...
  Object? beforeDecode(Object? value) {
    ...
    if (value != null &&
        value is! RealtimeSessionCreateResponseMaxResponseOutputTokensUnion &&
