...
class RealtimeServerEventResponseAudioTranscriptDoneMapper
    extends ClassMapperBase<RealtimeServerEventResponseAudioTranscriptDone> {
  ...
  static RealtimeServerEventResponseAudioTranscriptDoneTypeType _$type(
    RealtimeServerEventResponseAudioTranscriptDone v,
  ) => v.type;
  static const Field<
    RealtimeServerEventResponseAudioTranscriptDone,
    RealtimeServerEventResponseAudioTranscriptDoneTypeType
  >
...
>
  ...
  $R call({
    String? eventId,
    RealtimeServerEventResponseAudioTranscriptDoneTypeType? type,
    String? responseId,
    String? itemId,
    int? outputIndex,
    int? contentIndex,
