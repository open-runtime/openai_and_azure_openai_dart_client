...
class ResponseReasoningSummaryTextDeltaEventMapper
    extends ClassMapperBase<ResponseReasoningSummaryTextDeltaEvent> {
  ...
  static ResponseReasoningSummaryTextDeltaEventTypeType _$type(
    ResponseReasoningSummaryTextDeltaEvent v,
  ) => v.type;
  static const Field<
    ResponseReasoningSummaryTextDeltaEvent,
    ResponseReasoningSummaryTextDeltaEventTypeType
  >
...
>
  ...
  $R call({
    ResponseReasoningSummaryTextDeltaEventTypeType? type,
    String? itemId,
    int? outputIndex,
    int? summaryIndex,
    String? delta,
