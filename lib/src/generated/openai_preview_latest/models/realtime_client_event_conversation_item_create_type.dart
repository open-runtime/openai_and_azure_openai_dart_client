...
enum RealtimeClientEventConversationItemCreateType {
  ...
  static List<RealtimeClientEventConversationItemCreateType> get $valuesDefined => values.where((value) => value != RealtimeClientEventConversationItemCreateType.unknown).toList();
}
