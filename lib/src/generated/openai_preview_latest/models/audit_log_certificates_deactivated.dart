...
class AuditLogCertificatesDeactivated with AuditLogCertificatesDeactivatedMappable {
  const AuditLogCertificatesDeactivated({
    this.certificates,
  });

  final List<AuditLogCertificatesDeactivatedCertificates>? certificates;

  static AuditLogCertificatesDeactivated fromJson(Map<String, dynamic> json) => AuditLogCertificatesDeactivatedMapper.fromJson(json);
