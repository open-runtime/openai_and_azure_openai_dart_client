...
enum RealtimeServerEventConversationItemDeletedType {
  ...
  static List<RealtimeServerEventConversationItemDeletedType> get $valuesDefined =>
      values.where((value) => value != RealtimeServerEventConversationItemDeletedType.unknown).toList();
}
