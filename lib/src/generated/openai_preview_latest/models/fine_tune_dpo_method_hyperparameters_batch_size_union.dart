...
///
@MappableClass(ignoreNull: true, includeTypeId: false, includeSubClasses: [FineTuneDpoMethodHyperparametersBatchSizeUnionVariantString, FineTuneDpoMethodHyperparametersBatchSizeUnionVariantInt])
sealed class FineTuneDpoMethodHyperparametersBatchSizeUnion with FineTuneDpoMethodHyperparametersBatchSizeUnionMappable {
...
extension FineTuneDpoMethodHyperparametersBatchSizeUnionDeserializer on FineTuneDpoMethodHyperparametersBatchSizeUnion {
  static FineTuneDpoMethodHyperparametersBatchSizeUnion tryDeserialize(dynamic json) {
    ...
    throw FormatException('Could not determine the correct type for FineTuneDpoMethodHyperparametersBatchSizeUnion from: $json');
  }
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class FineTuneDpoMethodHyperparametersBatchSizeUnionVariantString extends FineTuneDpoMethodHyperparametersBatchSizeUnion with FineTuneDpoMethodHyperparametersBatchSizeUnionVariantStringMappable {
  final String value;

  const FineTuneDpoMethodHyperparametersBatchSizeUnionVariantString({
    required this.value,
  });
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class FineTuneDpoMethodHyperparametersBatchSizeUnionVariantInt extends FineTuneDpoMethodHyperparametersBatchSizeUnion with FineTuneDpoMethodHyperparametersBatchSizeUnionVariantIntMappable {
  final int value;

  const FineTuneDpoMethodHyperparametersBatchSizeUnionVariantInt({
    required this.value,
  });
}
