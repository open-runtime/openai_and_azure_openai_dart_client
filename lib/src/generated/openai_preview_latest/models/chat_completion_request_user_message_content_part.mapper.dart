...
class ChatCompletionRequestUserMessageContentPartFileMapper
    extends
        SubClassMapperBase<ChatCompletionRequestUserMessageContentPartFile> {
  ...
  _$chatCompletionRequestUserMessageContentPartFile(
    ChatCompletionRequestUserMessageContentPartFile v,
  ) => v.chatCompletionRequestUserMessageContentPartFile;
  static const Field<
    ChatCompletionRequestUserMessageContentPartFile,
    ChatCompletionRequestUserMessageContentPartFile
  >
  _f$chatCompletionRequestUserMessageContentPartFile = Field(
    'chatCompletionRequestUserMessageContentPartFile',
    _$chatCompletionRequestUserMessageContentPartFile,
    key: r'file',
  );
  ...
  final MappableFields<ChatCompletionRequestUserMessageContentPartFile> fields =
      const {
        #type: _f$type,
        #chatCompletionRequestUserMessageContentPartFile:
            _f$chatCompletionRequestUserMessageContentPartFile,
      };
  @override
  final bool ignoreNull = true;
  @override
  ...
  static ChatCompletionRequestUserMessageContentPartFile _instantiate(
    ...
    return ChatCompletionRequestUserMessageContentPartFile(
      type: data.dec(_f$type),
      chatCompletionRequestUserMessageContentPartFile: data.dec(
        _f$chatCompletionRequestUserMessageContentPartFile,
      ),
    );
  }
...
class _ChatCompletionRequestUserMessageContentPartFileCopyWithImpl<$R, $Out>
  ...
  ChatCompletionRequestUserMessageContentPartFileCopyWith<
    ...
    ChatCompletionRequestUserMessageContentPartFile
  >
  get chatCompletionRequestUserMessageContentPartFile => $value
      .chatCompletionRequestUserMessageContentPartFile
      .copyWith
  ...
  $R call({
    ...
    FieldCopyWithData({
      if (type != null) #type: type,
      if (chatCompletionRequestUserMessageContentPartFile != null)
        #chatCompletionRequestUserMessageContentPartFile:
            chatCompletionRequestUserMessageContentPartFile,
    }),
  );
  ...
  ChatCompletionRequestUserMessageContentPartFile $make(CopyWithData data) =>
      ChatCompletionRequestUserMessageContentPartFile(
        type: data.get(#type, or: $value.type),
        chatCompletionRequestUserMessageContentPartFile: data.get(
          #chatCompletionRequestUserMessageContentPartFile,
          or: $value.chatCompletionRequestUserMessageContentPartFile,
        ),
      );
