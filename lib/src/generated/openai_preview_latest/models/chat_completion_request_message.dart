...
extension ChatCompletionRequestMessageUnionDeserializer on ChatCompletionRequestMessage {
  static ChatCompletionRequestMessage tryDeserialize(
    ...
    final mappingFallback = const <Type, Object?>{
      ChatCompletionRequestMessageDeveloper: 'developer',
    ...
    return switch (value) {
      _ when value == effective[ChatCompletionRequestMessageDeveloper] => ChatCompletionRequestMessageDeveloperMapper.fromJson(json),
...
class ChatCompletionRequestMessageAssistant extends ChatCompletionRequestMessage with ChatCompletionRequestMessageAssistantMappable {
  ...
  final ChatCompletionRequestMessageAudio? chatCompletionRequestMessageAudio;
  @MappableField(key: 'tool_calls')
  final ChatCompletionMessageToolCalls? toolCalls;
  @MappableField(key: 'function_call')
  final ChatCompletionRequestMessageFunctionCall? chatCompletionRequestMessageFunctionCall;
  ...
  const ChatCompletionRequestMessageAssistant({
    ...
    required this.role,
    required this.name,
    required this.chatCompletionRequestMessageAudio,
    required this.toolCalls,
    required this.chatCompletionRequestMessageFunctionCall,
  });
}
