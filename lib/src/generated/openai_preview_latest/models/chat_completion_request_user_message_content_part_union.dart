...
extension ChatCompletionRequestUserMessageContentPartUnionDeserializer on ChatCompletionRequestUserMessageContentPartUnion {
  static ChatCompletionRequestUserMessageContentPartUnion tryDeserialize(Map<String, dynamic> json) {
    ...
    try {
      return ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartAudioMapper.fromJson(json);
    } catch (_) {}
    try {
      return ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMapper.fromJson(json);
    } catch (_) {}
...
@MappableClass()
class ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartAudio extends ChatCompletionRequestUserMessageContentPartUnion with ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartAudioMappable {
  ...
  const ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartAudio({
    required this.type,
...
@MappableClass()
class ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile extends ChatCompletionRequestUserMessageContentPartUnion with ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFileMappable {
  ...
  const ChatCompletionRequestUserMessageContentPartUnionChatCompletionRequestMessageContentPartFile({
    required this.type,
