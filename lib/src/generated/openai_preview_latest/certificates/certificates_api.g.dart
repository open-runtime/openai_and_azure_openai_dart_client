...
class _CertificatesApi implements CertificatesApi {
  _CertificatesApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<ListCertificatesResponse>> listOrganizationCertificates({
    ...
    late ListCertificatesResponse _value;
    try {
      _value = ListCertificatesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<Certificate>> uploadCertificate({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Certificate _value;
    try {
      _value = Certificate.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<HttpResponse<ListCertificatesResponse>>
  ...
  Future<HttpResponse<DeleteCertificateResponse>> deleteCertificate({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteCertificateResponse _value;
    try {
      _value = DeleteCertificateResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
