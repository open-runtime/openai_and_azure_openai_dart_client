...
/// Azure OpenAI Service API `v2024-05-01-preview`.
///
/// Azure OpenAI APIs for completions and search.
class AzureInferenceY2024M05D01PreviewClient {
  AzureInferenceY2024M05D01PreviewClient(Dio dio, {String? baseUrl}) : _dio = dio, _baseUrl = baseUrl;

  final Dio _dio;
  final String? _baseUrl;

  static String get version => '2024-05-01-preview';
