...
sealed class RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnion with RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionMappable {
...
extension RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionDeserializer on RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnion {
  static RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnion tryDeserialize(
    ...
    final mappingFallback = const <Type, Object?>{
      RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionLogs: 'logs',
      RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionImage: 'image',
    };
    final value = json[key];
    final effective = mapping ?? mappingFallback;
    return switch (value) {
      _ when value == effective[RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionLogs] => RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionLogsMapper.fromJson(json),
      _ when value == effective[RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionImage] => RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionImageMapper.fromJson(json),
      _ => throw FormatException('Unknown discriminator value "${json[key]}" for RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnion'),
    };
  }
}

@MappableClass(ignoreNull: true, includeTypeId: false, discriminatorValue: 'logs')
class RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionLogs extends RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnion with RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionLogsMappable {
...
class RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionImage extends RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnion with RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsUnionImageMappable {
  @MappableField(key: 'index')
  final int indexField;
