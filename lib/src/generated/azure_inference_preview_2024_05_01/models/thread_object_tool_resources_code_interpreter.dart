...
class ThreadObjectToolResourcesCodeInterpreter with ThreadObjectToolResourcesCodeInterpreterMappable {
  const ThreadObjectToolResourcesCodeInterpreter({
    this.fileIds = const [],
  });
  ...
  static ThreadObjectToolResourcesCodeInterpreter fromJson(Map<String, dynamic> json) => ThreadObjectToolResourcesCodeInterpreterMapper.fromJson(json);
