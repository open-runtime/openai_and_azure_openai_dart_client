...
class RunStepDeltaObjectMapper extends ClassMapperBase<RunStepDeltaObject> {
  ...
  static RunStepDeltaObjectDelta _$runStepDeltaObjectDelta(
    RunStepDeltaObject v,
  ) => v.runStepDeltaObjectDelta;
  static const Field<RunStepDeltaObject, RunStepDeltaObjectDelta>
  _f$runStepDeltaObjectDelta = Field(
    'runStepDeltaObjectDelta',
    _$runStepDeltaObjectDelta,
    key: r'RunStepDeltaObjectDelta',
  );
  ...
  final MappableFields<RunStepDeltaObject> fields = const {
    ...
    #runStepDeltaObjectDelta: _f$runStepDeltaObjectDelta,
  };
  ...
  static RunStepDeltaObject _instantiate(DecodingData data) {
    return RunStepDeltaObject(
      ...
      runStepDeltaObjectDelta: data.dec(_f$runStepDeltaObjectDelta),
    );
  }
...
class _RunStepDeltaObjectCopyWithImpl<$R, $Out>
  ...
  RunStepDeltaObjectDeltaCopyWith<
    ...
    RunStepDeltaObjectDelta
  >
  get runStepDeltaObjectDelta => $value.runStepDeltaObjectDelta.copyWith.$chain(
    (v) => call(runStepDeltaObjectDelta: v),
  );
  @override
  $R call({
    String? id,
    ...
    FieldCopyWithData({
      ...
      if (runStepDeltaObjectDelta != null)
        #runStepDeltaObjectDelta: runStepDeltaObjectDelta,
    }),
  );
  @override
  RunStepDeltaObject $make(CopyWithData data) => RunStepDeltaObject(
    ...
    runStepDeltaObjectDelta: data.get(
      #runStepDeltaObjectDelta,
      or: $value.runStepDeltaObjectDelta,
    ),
  );
