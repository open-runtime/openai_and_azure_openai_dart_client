...
@MappableClass(includeSubClasses: [MessageObjectAttachmentsToolsToolsUnionAssistantToolsCode, MessageObjectAttachmentsToolsToolsUnionAssistantToolsFileSearch])
...
extension MessageObjectAttachmentsToolsToolsUnionDeserializer on MessageObjectAttachmentsToolsToolsUnion {
  static MessageObjectAttachmentsToolsToolsUnion tryDeserialize(Map<String, dynamic> json) {
    ...
    try {
      return MessageObjectAttachmentsToolsToolsUnionAssistantToolsFileSearchMapper.fromJson(json);
    } catch (_) {}
...
@MappableClass()
class MessageObjectAttachmentsToolsToolsUnionAssistantToolsFileSearch extends MessageObjectAttachmentsToolsToolsUnion with MessageObjectAttachmentsToolsToolsUnionAssistantToolsFileSearchMappable {
  final AssistantToolsFileSearchTypeType type;

  const MessageObjectAttachmentsToolsToolsUnionAssistantToolsFileSearch({
    required this.type,
  });
}
