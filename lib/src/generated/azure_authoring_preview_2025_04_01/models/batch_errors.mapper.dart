...
class BatchErrorsMapper extends ClassMapperBase<BatchErrors> {
  ...
  static BatchErrorData? _$data(BatchErrors v) => v.data;
  static const Field<BatchErrors, BatchErrorData> _f$data = Field(
    'data',
    _$data,
    opt: true,
  );
...
abstract class BatchErrorsCopyWith<$R, $In extends BatchErrors, $Out>
  ...
  BatchErrorDataCopyWith<$R, BatchErrorData, BatchErrorData>? get data;
  $R call({String? objectField, BatchErrorData? data});
