...
@MappableClass()
class ChatCompletionRequestToolMessage with ChatCompletionRequestToolMessageMappable {
  ...
  static ChatCompletionRequestToolMessage fromJson(Map<String, dynamic> json) => ChatCompletionRequestToolMessageMapper.fromJson(json);
