...
extension RunStepDeltaObjectDeltaStepDetailsUnionDeserializer on RunStepDeltaObjectDeltaStepDetailsUnion {
  static RunStepDeltaObjectDeltaStepDetailsUnion tryDeserialize(
    ...
    final mappingFallback = const <Type, Object?>{
      RunStepDeltaStepDetailsMessageCreationObject: 'message_creation',
      RunStepDeltaStepDetailsToolCallsObject: 'tool_calls',
    };
    final value = json[key];
    final effective = mapping ?? mappingFallback;
    return switch (value) {
      _ when value == effective[RunStepDeltaStepDetailsMessageCreationObject] =>
        RunStepDeltaStepDetailsMessageCreationObjectMapper.fromJson(json),
      _ when value == effective[RunStepDeltaStepDetailsToolCallsObject] =>
        RunStepDeltaStepDetailsToolCallsObjectMapper.fromJson(json),
      _ => throw FormatException(
        'Unknown discriminator value "${json[key]}" for RunStepDeltaObjectDeltaStepDetailsUnion',
      ),
    };
  }
}
...
class RunStepDeltaObjectDeltaStepDetailsUnionMessageCreation extends RunStepDeltaObjectDeltaStepDetailsUnion
    with RunStepDeltaObjectDeltaStepDetailsUnionMessageCreationMappable {
...
class RunStepDeltaObjectDeltaStepDetailsUnionToolCalls extends RunStepDeltaObjectDeltaStepDetailsUnion
    with RunStepDeltaObjectDeltaStepDetailsUnionToolCallsMappable {
  ...
  const RunStepDeltaObjectDeltaStepDetailsUnionToolCalls({required this.type, required this.toolCalls});
}
