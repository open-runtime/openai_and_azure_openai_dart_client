...
class AzureSearchChatExtensionParametersEmbeddingDependencyUnionMapper
  ...
  ensureInitialized() {
    if (_instance == null) {
      ...
      AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceMapper
    extends
        ClassMapperBase<
          AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource
        > {
  AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceMapper._();

  static AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceMapper?
  _instance;
  static AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceMapper
  ensureInitialized() {
    if (_instance == null) {
  ...
  static AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource
  _instantiate(DecodingData data) {
    return AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource();
  }
...
mixin AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceMappable {
  String toJsonString() {
    return AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceMapper.ensureInitialized()
        .encodeJson<
          AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource
        >(
          this
              as AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource,
        );
  }
  ...
  AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceCopyWith<
    AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource,
    AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource,
    AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource
  >
  get copyWith =>
      _AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceCopyWithImpl<
        AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource,
        AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource
      >(
        this
...
extension AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceValueCopy<
  $R,
  $Out
>
    on
  ...
  AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceCopyWith<
    ...
    $Out
  >
  get $asAzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource =>
      $base.as(
        (v, t, t2) =>
            _AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceCopyWithImpl<
              $R,
...
abstract class AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceCopyWith<
  $R,
  $In extends AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSource,
  $Out
>
    implements
        AzureSearchChatExtensionParametersEmbeddingDependencyUnionCopyWith<
...
class _AzureSearchChatExtensionParametersEmbeddingDependencyUnionOnYourDataIntegratedVectorizationSourceCopyWithImpl<
  $R,
  $Out
>
    extends
