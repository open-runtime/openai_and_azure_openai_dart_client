...
enum OnYourDataAuthenticationType {
  ...
  @MappableValue('key_and_key_id')
  keyAndKeyId,

  @MappableValue('encoded_api_key')
  encodedApiKey,

  @MappableValue('access_token')
  accessToken,
  ...
  @MappableValue('username_and_password')
  usernameAndPassword,
  ...
  static List<OnYourDataAuthenticationType> get $valuesDefined =>
      values.where((value) => value != OnYourDataAuthenticationType.unknown).toList();
}
