...
class CreateChatCompletionRequestFunctionCallUnionVariant1 extends CreateChatCompletionRequestFunctionCallUnion
    with CreateChatCompletionRequestFunctionCallUnionVariant1Mappable {
  final String name;

  const CreateChatCompletionRequestFunctionCallUnionVariant1({required this.name});
}
