...
class _EvalsApi implements EvalsApi {
  _EvalsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<Eval>> createEval({
    required CreateEvalRequest body,
    Map<String, dynamic>? extras,
    RequestOptions? options,
  }) async {
    final _extra = <String, dynamic>{};
  ...
  Future<HttpResponse<DeleteEvalResponse>> deleteEval({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteEvalResponse _value;
    try {
      _value = DeleteEvalResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<HttpResponse<DeleteEvalRunResponse>> deleteEvalRun({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteEvalRunResponse _value;
    try {
      _value = DeleteEvalRunResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
