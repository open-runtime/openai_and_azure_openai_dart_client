...
class RealtimeTranscriptionSessionCreateRequestGaAudioInput
    with RealtimeTranscriptionSessionCreateRequestGaAudioInputMappable {
  ...
  static RealtimeTranscriptionSessionCreateRequestGaAudioInput fromJson(Map<String, dynamic> json) =>
      RealtimeTranscriptionSessionCreateRequestGaAudioInputMapper.fromJson(json);
}
