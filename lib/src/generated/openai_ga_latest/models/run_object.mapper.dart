...
class RunObjectMapper extends ClassMapperBase<RunObject> {
  ...
  static RunStatus _$status(RunObject v) => v.status;
  static const Field<RunObject, RunStatus> _f$status = Field(
    'status',
    _$status,
  );
  ...
  static Metadata _$metadata(RunObject v) => v.metadata;
  static const Field<RunObject, Metadata> _f$metadata = Field(
    'metadata',
    _$metadata,
  );
  static RunCompletionUsageUnion? _$usage(RunObject v) => v.usage;
  static const Field<RunObject, RunCompletionUsageUnion> _f$usage = Field(
    'usage',
    _$usage,
  );
  ...
  static bool _$parallelToolCalls(RunObject v) => v.parallelToolCalls;
  static const Field<RunObject, bool> _f$parallelToolCalls = Field(
    'parallelToolCalls',
    _$parallelToolCalls,
  ...
  static List<AssistantTool> _$tools(RunObject v) => v.tools;
  static const Field<RunObject, List<AssistantTool>> _f$tools = Field(
    'tools',
    _$tools,
    opt: true,
    def: const [],
