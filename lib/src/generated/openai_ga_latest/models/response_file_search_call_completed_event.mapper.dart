...
class ResponseFileSearchCallCompletedEventMapper
  ...
  static ResponseFileSearchCallCompletedEventTypeType _$type(
    ResponseFileSearchCallCompletedEvent v,
  ) => v.type;
  static const Field<
    ResponseFileSearchCallCompletedEvent,
    ResponseFileSearchCallCompletedEventTypeType
  >
  ...
  static int _$sequenceNumber(ResponseFileSearchCallCompletedEvent v) =>
      v.sequenceNumber;
  static const Field<ResponseFileSearchCallCompletedEvent, int>
...
>
  ...
  $R call({
    ResponseFileSearchCallCompletedEventTypeType? type,
    int? outputIndex,
    String? itemId,
    int? sequenceNumber,
  });
