...
extension RealtimeConversationItemErrorUnionDeserializer on RealtimeConversationItemErrorUnion {
  static RealtimeConversationItemErrorUnion tryDeserialize(
    ...
    final mappingFallback = const <Type, Object?>{
      RealtimeConversationItemErrorUnionProtocolError: 'protocol_error',
      RealtimeConversationItemErrorUnionToolExecutionError: 'tool_execution_error',
      RealtimeConversationItemErrorUnionHttpError: 'http_error',
    };
    final value = json[key];
    final effective = mapping ?? mappingFallback;
    return switch (value) {
      _ when value == effective[RealtimeConversationItemErrorUnionProtocolError] => RealtimeConversationItemErrorUnionProtocolErrorMapper.fromJson(json),
      _ when value == effective[RealtimeConversationItemErrorUnionToolExecutionError] => RealtimeConversationItemErrorUnionToolExecutionErrorMapper.fromJson(json),
      _ when value == effective[RealtimeConversationItemErrorUnionHttpError] => RealtimeConversationItemErrorUnionHttpErrorMapper.fromJson(json),
...
class RealtimeConversationItemErrorUnionHttpError extends RealtimeConversationItemErrorUnion with RealtimeConversationItemErrorUnionHttpErrorMappable {
  ...
  const RealtimeConversationItemErrorUnionHttpError({
    required this.type,
    required this.code,
    required this.message,
  });
