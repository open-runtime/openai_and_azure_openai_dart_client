...
class CreateUploadRequestMapper extends ClassMapperBase<CreateUploadRequest> {
  ...
  static FileExpirationAfter? _$expiresAfter(CreateUploadRequest v) =>
      v.expiresAfter;
  static const Field<CreateUploadRequest, FileExpirationAfter> _f$expiresAfter =
...
>
  ...
  FileExpirationAfterCopyWith<$R, FileExpirationAfter, FileExpirationAfter>?
  get expiresAfter;
  $R call({
    String? filename,
    ...
    int? bytes,
    String? mimeType,
    FileExpirationAfter? expiresAfter,
  });
