...
extension FunctionAndCustomToolCallOutputUnionDeserializer on FunctionAndCustomToolCallOutput {
  static FunctionAndCustomToolCallOutput tryDeserialize(
    ...
    final mappingFallback = const <Type, Object?>{
      FunctionAndCustomToolCallOutputInputText: 'input_text',
      FunctionAndCustomToolCallOutputInputImage: 'input_image',
      FunctionAndCustomToolCallOutputInputFile: 'input_file',
    };
    final value = json[key];
    final effective = mapping ?? mappingFallback;
    return switch (value) {
      _ when value == effective[FunctionAndCustomToolCallOutputInputText] => FunctionAndCustomToolCallOutputInputTextMapper.fromJson(json),
      _ when value == effective[FunctionAndCustomToolCallOutputInputImage] => FunctionAndCustomToolCallOutputInputImageMapper.fromJson(json),
      _ when value == effective[FunctionAndCustomToolCallOutputInputFile] => FunctionAndCustomToolCallOutputInputFileMapper.fromJson(json),
