...
class CreateVectorStoreRequestMapper
  ...
  static String? _$description(CreateVectorStoreRequest v) => v.description;
  static const Field<CreateVectorStoreRequest, String> _f$description = Field(
    'description',
    _$description,
    opt: true,
  );
  ...
  static Metadata? _$metadata(CreateVectorStoreRequest v) => v.metadata;
  static const Field<CreateVectorStoreRequest, Metadata> _f$metadata = Field(
    'metadata',
    _$metadata,
    opt: true,
  );
