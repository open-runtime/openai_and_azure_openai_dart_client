...
sealed class RunStepDetailsToolCallCodeInterpreterOutputsUnion
    with RunStepDetailsToolCallCodeInterpreterOutputsUnionMappable {
...
extension RunStepDetailsToolCallCodeInterpreterOutputsUnionDeserializer
    on RunStepDetailsToolCallCodeInterpreterOutputsUnion {
  static RunStepDetailsToolCallCodeInterpreterOutputsUnion tryDeserialize(
    ...
    return switch (value) {
      ...
      _ => throw FormatException(
        'Unknown discriminator value "${json[key]}" for RunStepDetailsToolCallCodeInterpreterOutputsUnion',
      ),
    };
  }
}
...
class RunStepDetailsToolCallCodeInterpreterOutputsUnionLogs extends RunStepDetailsToolCallCodeInterpreterOutputsUnion
    with RunStepDetailsToolCallCodeInterpreterOutputsUnionLogsMappable {
  final RunStepDetailsToolCallsCodeOutputLogsObjectType type;
  final String logs;

  const RunStepDetailsToolCallCodeInterpreterOutputsUnionLogs({required this.type, required this.logs});
}

@MappableClass(ignoreNull: true, includeTypeId: false, discriminatorValue: 'image')
class RunStepDetailsToolCallCodeInterpreterOutputsUnionImage extends RunStepDetailsToolCallCodeInterpreterOutputsUnion
    with RunStepDetailsToolCallCodeInterpreterOutputsUnionImageMappable {
