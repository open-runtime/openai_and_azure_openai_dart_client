...
class CreateImageRequestMapper extends ClassMapperBase<CreateImageRequest> {
  ...
  static bool? _$stream(CreateImageRequest v) => v.stream;
  static const Field<CreateImageRequest, bool> _f$stream = Field(
    'stream',
    _$stream,
    opt: true,
    def: false,
  ...
  static PartialImages? _$partialImages(CreateImageRequest v) =>
      v.partialImages;
  static const Field<CreateImageRequest, PartialImages> _f$partialImages =
      Field(
        'partialImages',
        _$partialImages,
...
class _CreateImageRequestCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (partialImages != $none) #partialImages: partialImages,
