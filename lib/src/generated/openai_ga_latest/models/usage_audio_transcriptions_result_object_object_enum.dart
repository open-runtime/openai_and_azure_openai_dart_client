...
enum UsageAudioTranscriptionsResultObjectObjectEnum {
  ...
  static List<UsageAudioTranscriptionsResultObjectObjectEnum> get $valuesDefined => values.where((value) => value != UsageAudioTranscriptionsResultObjectObjectEnum.unknown).toList();
}
