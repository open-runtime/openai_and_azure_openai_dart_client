...
class CodeInterpreterToolCallStatusStatusMapper
  ...
  CodeInterpreterToolCallStatusStatus decode(dynamic value) {
    switch (value) {
      ...
      case 'incomplete':
        return CodeInterpreterToolCallStatusStatus.incomplete;
      case 'interpreting':
        return CodeInterpreterToolCallStatusStatus.interpreting;
      case 'failed':
        return CodeInterpreterToolCallStatusStatus.failed;
      case 'unknown':
  ...
  dynamic encode(CodeInterpreterToolCallStatusStatus self) {
    switch (self) {
      ...
      case CodeInterpreterToolCallStatusStatus.completed:
        return 'completed';
      case CodeInterpreterToolCallStatusStatus.incomplete:
        return 'incomplete';
      case CodeInterpreterToolCallStatusStatus.interpreting:
        return 'interpreting';
      case CodeInterpreterToolCallStatusStatus.failed:
        return 'failed';
