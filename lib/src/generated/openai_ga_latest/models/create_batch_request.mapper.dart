...
class CreateBatchRequestMapper extends ClassMapperBase<CreateBatchRequest> {
  ...
  static Metadata? _$metadata(CreateBatchRequest v) => v.metadata;
  static const Field<CreateBatchRequest, Metadata> _f$metadata = Field(
    'metadata',
    _$metadata,
    opt: true,
  );
  static BatchFileExpirationAfter? _$outputExpiresAfter(CreateBatchRequest v) =>
      v.outputExpiresAfter;
  static const Field<CreateBatchRequest, BatchFileExpirationAfter>
