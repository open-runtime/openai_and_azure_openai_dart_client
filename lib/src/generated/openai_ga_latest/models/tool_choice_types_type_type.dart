...
part 'tool_choice_types_type_type.mapper.dart';
...
enum ToolChoiceTypesTypeType {
  ...
  static List<ToolChoiceTypesTypeType> get $valuesDefined => values.where((value) => value != ToolChoiceTypesTypeType.unknown).toList();
}
