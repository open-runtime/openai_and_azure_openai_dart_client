...
@MappableClass(includeSubClasses: [EvalDataSourceConfigDataSourceConfigUnionEvalCustomDataSourceConfig, EvalDataSourceConfigDataSourceConfigUnionEvalLogsDataSourceConfig, EvalDataSourceConfigDataSourceConfigUnionEvalStoredCompletionsDataSourceConfig])
...
extension EvalDataSourceConfigDataSourceConfigUnionDeserializer on EvalDataSourceConfigDataSourceConfigUnion {
  static EvalDataSourceConfigDataSourceConfigUnion tryDeserialize(Map<String, dynamic> json) {
    ...
    try {
      return EvalDataSourceConfigDataSourceConfigUnionEvalLogsDataSourceConfigMapper.fromJson(json);
    } catch (_) {}
    try {
...
@MappableClass()
class EvalDataSourceConfigDataSourceConfigUnionEvalLogsDataSourceConfig extends EvalDataSourceConfigDataSourceConfigUnion with EvalDataSourceConfigDataSourceConfigUnionEvalLogsDataSourceConfigMappable {
  final EvalLogsDataSourceConfigTypeType type;
  final Metadata? metadata;
  final dynamic schema;

  const EvalDataSourceConfigDataSourceConfigUnionEvalLogsDataSourceConfig({
    required this.type,
