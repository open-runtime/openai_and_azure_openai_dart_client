...
class CodeInterpreterToolCallStatusMapper
  ...
  CodeInterpreterToolCallStatus decode(dynamic value) {
    switch (value) {
      ...
      case 'incomplete':
        return CodeInterpreterToolCallStatus.incomplete;
      case 'interpreting':
        return CodeInterpreterToolCallStatus.interpreting;
      case 'failed':
        return CodeInterpreterToolCallStatus.failed;
      case 'unknown':
  ...
  dynamic encode(CodeInterpreterToolCallStatus self) {
    switch (self) {
      ...
      case CodeInterpreterToolCallStatus.completed:
        return 'completed';
      case CodeInterpreterToolCallStatus.incomplete:
        return 'incomplete';
      case CodeInterpreterToolCallStatus.interpreting:
        return 'interpreting';
      case CodeInterpreterToolCallStatus.failed:
        return 'failed';
