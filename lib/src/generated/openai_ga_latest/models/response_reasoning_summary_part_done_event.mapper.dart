...
class ResponseReasoningSummaryPartDoneEventMapper
  ...
  static ResponseReasoningSummaryPartDoneEventTypeType _$type(
    ResponseReasoningSummaryPartDoneEvent v,
  ) => v.type;
  static const Field<
    ResponseReasoningSummaryPartDoneEvent,
    ResponseReasoningSummaryPartDoneEventTypeType
  >
  ...
  static int _$sequenceNumber(ResponseReasoningSummaryPartDoneEvent v) =>
      v.sequenceNumber;
  static const Field<ResponseReasoningSummaryPartDoneEvent, int>
  ...
  _f$responseReasoningSummaryPartDoneEventPart = Field(
    'responseReasoningSummaryPartDoneEventPart',
    _$responseReasoningSummaryPartDoneEventPart,
    key: r'ResponseReasoningSummaryPartDoneEventPart',
  );
...
>
  ...
  $R call({
    ResponseReasoningSummaryPartDoneEventTypeType? type,
    String? itemId,
    int? outputIndex,
    int? summaryIndex,
    int? sequenceNumber,
