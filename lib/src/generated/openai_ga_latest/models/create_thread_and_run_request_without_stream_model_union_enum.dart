...
enum CreateThreadAndRunRequestWithoutStreamModelUnionEnum {
  ...
  static List<CreateThreadAndRunRequestWithoutStreamModelUnionEnum> get $valuesDefined =>
      values.where((value) => value != CreateThreadAndRunRequestWithoutStreamModelUnionEnum.unknown).toList();
}
