...
part 'realtime_session_create_response_ga_model_union_enum.mapper.dart';
...
enum RealtimeSessionCreateResponseGaModelUnionEnum {
  ...
  static List<RealtimeSessionCreateResponseGaModelUnionEnum> get $valuesDefined => values.where((value) => value != RealtimeSessionCreateResponseGaModelUnionEnum.unknown).toList();
}
