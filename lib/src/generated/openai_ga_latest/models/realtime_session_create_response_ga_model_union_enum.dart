...
enum RealtimeSessionCreateResponseGaModelUnionEnum {
  ...
  static List<RealtimeSessionCreateResponseGaModelUnionEnum> get $valuesDefined =>
      values.where((value) => value != RealtimeSessionCreateResponseGaModelUnionEnum.unknown).toList();
}
