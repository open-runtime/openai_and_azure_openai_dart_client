...
class BatchRequestOutputMapper extends ClassMapperBase<BatchRequestOutput> {
  ...
  static BatchRequestOutputResponse? _$response(BatchRequestOutput v) =>
      v.response;
  static const Field<BatchRequestOutput, BatchRequestOutputResponse>
  _f$response = Field('response', _$response, opt: true);
  static BatchRequestOutputError? _$error(BatchRequestOutput v) => v.error;
  static const Field<BatchRequestOutput, BatchRequestOutputError> _f$error =
