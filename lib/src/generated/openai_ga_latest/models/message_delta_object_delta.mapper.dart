...
class MessageDeltaObjectDeltaMapper
  ...
  static List<MessageContentDelta>? _$content(MessageDeltaObjectDelta v) =>
      v.content;
  static const Field<MessageDeltaObjectDelta, List<MessageContentDelta>>
...
>
  ...
  ListCopyWith<
    $R,
    MessageContentDelta,
    MessageContentDeltaCopyWith<$R, MessageContentDelta, MessageContentDelta>
  >?
  get content;
  $R call({
    MessageDeltaObjectDeltaRoleRole? role,
    List<MessageContentDelta>? content,
  });
