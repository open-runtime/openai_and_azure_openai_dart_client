...
class MessageObjectMapper extends ClassMapperBase<MessageObject> {
  ...
  static MessageObjectIncompleteDetails? _$incompleteDetails(MessageObject v) =>
      v.incompleteDetails;
  ...
  static List<MessageContent> _$content(MessageObject v) => v.content;
  static const Field<MessageObject, List<MessageContent>> _f$content = Field(
    'content',
    _$content,
  );
  ...
  static Metadata _$metadata(MessageObject v) => v.metadata;
  static const Field<MessageObject, Metadata> _f$metadata = Field(
    'metadata',
    _$metadata,
  );
...
abstract class MessageObjectCopyWith<$R, $In extends MessageObject, $Out>
  ...
  ListCopyWith<
    $R,
    MessageContent,
    MessageContentCopyWith<$R, MessageContent, MessageContent>
  >
  get content;
  ListCopyWith<
    $R,
