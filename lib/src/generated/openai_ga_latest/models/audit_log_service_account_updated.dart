...
class AuditLogServiceAccountUpdated with AuditLogServiceAccountUpdatedMappable {
  const AuditLogServiceAccountUpdated({this.id, this.auditLogServiceAccountUpdatedChangesRequested});
  ...
  static AuditLogServiceAccountUpdated fromJson(Map<String, dynamic> json) =>
      AuditLogServiceAccountUpdatedMapper.fromJson(json);
}
