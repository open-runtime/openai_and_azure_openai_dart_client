...
sealed class RealtimeSessionCreateResponseGaToolChoiceUnion
    with RealtimeSessionCreateResponseGaToolChoiceUnionMappable {
...
extension RealtimeSessionCreateResponseGaToolChoiceUnionDeserializer on RealtimeSessionCreateResponseGaToolChoiceUnion {
  static RealtimeSessionCreateResponseGaToolChoiceUnion tryDeserialize(Map<String, dynamic> json) {
    ...
    throw FormatException(
      'Could not determine the correct type for RealtimeSessionCreateResponseGaToolChoiceUnion from: $json',
    );
  }
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class RealtimeSessionCreateResponseGaToolChoiceUnionToolChoiceFunction
    extends RealtimeSessionCreateResponseGaToolChoiceUnion
    with RealtimeSessionCreateResponseGaToolChoiceUnionToolChoiceFunctionMappable {
  final ToolChoiceFunctionType type;
  final String name;

  const RealtimeSessionCreateResponseGaToolChoiceUnionToolChoiceFunction({required this.type, required this.name});
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class RealtimeSessionCreateResponseGaToolChoiceUnionToolChoiceMcp extends RealtimeSessionCreateResponseGaToolChoiceUnion
    with RealtimeSessionCreateResponseGaToolChoiceUnionToolChoiceMcpMappable {
...
@MappableClass(ignoreNull: true, includeTypeId: false)
class RealtimeSessionCreateResponseGaToolChoiceUnionVariantString extends RealtimeSessionCreateResponseGaToolChoiceUnion
    with RealtimeSessionCreateResponseGaToolChoiceUnionVariantStringMappable {
  final String value;

  const RealtimeSessionCreateResponseGaToolChoiceUnionVariantString({required this.value});
}
