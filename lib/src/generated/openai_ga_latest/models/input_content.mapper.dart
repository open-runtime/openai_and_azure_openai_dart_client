...
class InputContentInputImageMapper
  ...
  static ImageDetail _$detail(InputContentInputImage v) => v.detail;
  static const Field<InputContentInputImage, ImageDetail> _f$detail = Field(
    'detail',
    _$detail,
  );
...
class InputContentInputFileMapper
  ...
  static String? _$fileUrl(InputContentInputFile v) => v.fileUrl;
  static const Field<InputContentInputFile, String> _f$fileUrl = Field(
    'fileUrl',
    _$fileUrl,
    key: r'file_url',
  );
