...
@MappableClass(
  ...
  includeSubClasses: [UserMessageItemContentUnionInputText, UserMessageItemContentUnionQuotedText],
)
...
class UserMessageItemContentUnionInputText extends UserMessageItemContentUnion
    with UserMessageItemContentUnionInputTextMappable {
  final UserMessageInputTextType type;
  final String text;

  const UserMessageItemContentUnionInputText({required this.type, required this.text});
}

@MappableClass(ignoreNull: true, includeTypeId: false, discriminatorValue: 'quoted_text')
class UserMessageItemContentUnionQuotedText extends UserMessageItemContentUnion
    with UserMessageItemContentUnionQuotedTextMappable {
  final UserMessageQuotedTextType type;
  final String text;

  const UserMessageItemContentUnionQuotedText({required this.type, required this.text});
}
