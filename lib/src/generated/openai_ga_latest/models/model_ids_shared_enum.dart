...
part 'model_ids_shared_enum.mapper.dart';

/// Enum values: gpt-5.1, gpt-5.1-2025-11-13, gpt-5.1-codex, gpt-5.1-mini, gpt-5.1-chat-latest, gpt-5, gpt-5-mini, gpt-5-nano, gpt-5-2025-08-07, gpt-5-mini-2025-08-07, gpt-5-nano-2025-08-07, gpt-5-chat-latest, gpt-4.1, gpt-4.1-mini, gpt-4.1-nano, gpt-4.1-2025-04-14, gpt-4.1-mini-2025-04-14, gpt-4.1-nano-2025-04-14, o4-mini, o4-mini-2025-04-16, o3, o3-2025-04-16, o3-mini, o3-mini-2025-01-31, o1, o1-2024-12-17, o1-preview, o1-preview-2024-09-12, o1-mini, o1-mini-2024-09-12, gpt-4o, gpt-4o-2024-11-20, gpt-4o-2024-08-06, gpt-4o-2024-05-13, gpt-4o-audio-preview, gpt-4o-audio-preview-2024-10-01, gpt-4o-audio-preview-2024-12-17, gpt-4o-audio-preview-2025-06-03, gpt-4o-mini-audio-preview, gpt-4o-mini-audio-preview-2024-12-17, gpt-4o-search-preview, gpt-4o-mini-search-preview, gpt-4o-search-preview-2025-03-11, gpt-4o-mini-search-preview-2025-03-11, chatgpt-4o-latest, codex-mini-latest, gpt-4o-mini, gpt-4o-mini-2024-07-18, gpt-4-turbo, gpt-4-turbo-2024-04-09, gpt-4-0125-preview, gpt-4-turbo-preview, gpt-4-1106-preview, gpt-4-vision-preview, gpt-4, gpt-4-0314, gpt-4-0613, gpt-4-32k, gpt-4-32k-0314, gpt-4-32k-0613, gpt-3.5-turbo, gpt-3.5-turbo-16k, gpt-3.5-turbo-0301, gpt-3.5-turbo-0613, gpt-3.5-turbo-1106, gpt-3.5-turbo-0125, gpt-3.5-turbo-16k-0613
@MappableEnum(defaultValue: 'unknown')
enum ModelIdsSharedEnum {
  /// Incorrect name has been replaced. Original name: `gpt-5.1`.
  @MappableValue('gpt-5.1') 
  undefined0,

  /// Incorrect name has been replaced. Original name: `gpt-5.1-2025-11-13`.
  @MappableValue('gpt-5.1-2025-11-13') 
  undefined1,

  /// Incorrect name has been replaced. Original name: `gpt-5.1-codex`.
  @MappableValue('gpt-5.1-codex') 
  undefined2,

  /// Incorrect name has been replaced. Original name: `gpt-5.1-mini`.
  @MappableValue('gpt-5.1-mini') 
  undefined3,

  /// Incorrect name has been replaced. Original name: `gpt-5.1-chat-latest`.
  @MappableValue('gpt-5.1-chat-latest') 
  undefined4,

  @MappableValue('gpt-5') 
  gpt5,

  @MappableValue('gpt-5-mini') 
  gpt5Mini,

  @MappableValue('gpt-5-nano') 
  gpt5Nano,

  @MappableValue('gpt-5-2025-08-07') 
  gpt520250807,

  @MappableValue('gpt-5-mini-2025-08-07') 
  gpt5Mini20250807,

  @MappableValue('gpt-5-nano-2025-08-07') 
  gpt5Nano20250807,

  @MappableValue('gpt-5-chat-latest') 
  gpt5ChatLatest,
  ...
  @MappableValue('o4-mini') 
  o4Mini,

  @MappableValue('o4-mini-2025-04-16') 
  o4Mini20250416,

  @MappableValue('o3') 
  o3,

  @MappableValue('o3-2025-04-16') 
  o320250416,
  ...
  @MappableValue('o1-preview') 
  o1Preview,

  @MappableValue('o1-preview-2024-09-12') 
  o1Preview20240912,

  @MappableValue('o1-mini') 
  o1Mini,

  @MappableValue('o1-mini-2024-09-12') 
  o1Mini20240912,
  ...
  @MappableValue('gpt-4o-audio-preview') 
  gpt4oAudioPreview,

  @MappableValue('gpt-4o-audio-preview-2024-10-01') 
  gpt4oAudioPreview20241001,

  @MappableValue('gpt-4o-audio-preview-2024-12-17') 
  gpt4oAudioPreview20241217,

  @MappableValue('gpt-4o-audio-preview-2025-06-03') 
  gpt4oAudioPreview20250603,

  @MappableValue('gpt-4o-mini-audio-preview') 
  gpt4oMiniAudioPreview,

  @MappableValue('gpt-4o-mini-audio-preview-2024-12-17') 
  gpt4oMiniAudioPreview20241217,

  @MappableValue('gpt-4o-search-preview') 
  gpt4oSearchPreview,

  @MappableValue('gpt-4o-mini-search-preview') 
  gpt4oMiniSearchPreview,

  @MappableValue('gpt-4o-search-preview-2025-03-11') 
  gpt4oSearchPreview20250311,

  @MappableValue('gpt-4o-mini-search-preview-2025-03-11') 
  gpt4oMiniSearchPreview20250311,

  @MappableValue('chatgpt-4o-latest') 
  chatgpt4oLatest,

  @MappableValue('codex-mini-latest') 
  codexMiniLatest,
  ...
  /// Incorrect name has been replaced. Original name: `gpt-3.5-turbo-0301`.
  @MappableValue('gpt-3.5-turbo-0301') 
  undefined13,
  ...
  static List<ModelIdsSharedEnum> get $valuesDefined => values.where((value) => value != ModelIdsSharedEnum.unknown).toList();
}
