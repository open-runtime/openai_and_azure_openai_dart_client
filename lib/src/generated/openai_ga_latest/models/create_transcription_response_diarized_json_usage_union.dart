...
sealed class CreateTranscriptionResponseDiarizedJsonUsageUnion
    with CreateTranscriptionResponseDiarizedJsonUsageUnionMappable {
...
extension CreateTranscriptionResponseDiarizedJsonUsageUnionDeserializer
    on CreateTranscriptionResponseDiarizedJsonUsageUnion {
  static CreateTranscriptionResponseDiarizedJsonUsageUnion tryDeserialize(
    ...
    return switch (value) {
      ...
      _ => throw FormatException(
        'Unknown discriminator value "${json[key]}" for CreateTranscriptionResponseDiarizedJsonUsageUnion',
      ),
    };
  }
}
...
class CreateTranscriptionResponseDiarizedJsonUsageUnionTokens extends CreateTranscriptionResponseDiarizedJsonUsageUnion
    with CreateTranscriptionResponseDiarizedJsonUsageUnionTokensMappable {
...
class CreateTranscriptionResponseDiarizedJsonUsageUnionDuration
    extends CreateTranscriptionResponseDiarizedJsonUsageUnion
    with CreateTranscriptionResponseDiarizedJsonUsageUnionDurationMappable {
  final TranscriptTextUsageDurationType type;
  final num seconds;

  const CreateTranscriptionResponseDiarizedJsonUsageUnionDuration({required this.type, required this.seconds});
}
