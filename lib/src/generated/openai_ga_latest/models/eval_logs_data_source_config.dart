...
class EvalLogsDataSourceConfig extends EvalDataSourceConfigUnion with EvalLogsDataSourceConfigMappable {
  const EvalLogsDataSourceConfig({required this.schema, this.metadata, this.type = EvalLogsDataSourceConfigType.logs});
