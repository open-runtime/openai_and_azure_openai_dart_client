...
part 'audio_transcription_model_model.mapper.dart';
...
enum AudioTranscriptionModelModel {
  ...
  static List<AudioTranscriptionModelModel> get $valuesDefined => values.where((value) => value != AudioTranscriptionModelModel.unknown).toList();
}
