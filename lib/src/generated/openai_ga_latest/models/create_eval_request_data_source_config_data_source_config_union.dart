...
extension CreateEvalRequestDataSourceConfigDataSourceConfigUnionDeserializer on CreateEvalRequestDataSourceConfigDataSourceConfigUnion {
  static CreateEvalRequestDataSourceConfigDataSourceConfigUnion tryDeserialize(Map<String, dynamic> json) {
    ...
    try {
      return CreateEvalRequestDataSourceConfigDataSourceConfigUnionCreateEvalStoredCompletionsDataSourceConfigMapper.fromJson(json);
    } catch (_) {}
...
@MappableClass()
class CreateEvalRequestDataSourceConfigDataSourceConfigUnionCreateEvalStoredCompletionsDataSourceConfig extends CreateEvalRequestDataSourceConfigDataSourceConfigUnion with CreateEvalRequestDataSourceConfigDataSourceConfigUnionCreateEvalStoredCompletionsDataSourceConfigMappable {
  final CreateEvalStoredCompletionsDataSourceConfigTypeType type;
  final dynamic metadata;

  const CreateEvalRequestDataSourceConfigDataSourceConfigUnionCreateEvalStoredCompletionsDataSourceConfig({
    required this.type,
    required this.metadata,
  });
}
