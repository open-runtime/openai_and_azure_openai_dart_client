...
class CreateSpeechRequest with CreateSpeechRequestMappable {
  const CreateSpeechRequest({
    ...
    this.speed = 1,
    this.streamFormat = CreateSpeechRequestStreamFormatStreamFormat.audio,
    this.instructions,
  });
  ...
  final num speed;
  @MappableField(key: 'stream_format')
  final CreateSpeechRequestStreamFormatStreamFormat streamFormat;
