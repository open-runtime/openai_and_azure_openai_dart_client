...
///
@MappableClass(ignoreNull: true, includeTypeId: false, includeSubClasses: [FineTuneReinforcementHyperparametersBatchSizeUnionVariantString, FineTuneReinforcementHyperparametersBatchSizeUnionVariantInt])
sealed class FineTuneReinforcementHyperparametersBatchSizeUnion with FineTuneReinforcementHyperparametersBatchSizeUnionMappable {
...
extension FineTuneReinforcementHyperparametersBatchSizeUnionDeserializer on FineTuneReinforcementHyperparametersBatchSizeUnion {
  static FineTuneReinforcementHyperparametersBatchSizeUnion tryDeserialize(dynamic json) {
    ...
    throw FormatException('Could not determine the correct type for FineTuneReinforcementHyperparametersBatchSizeUnion from: $json');
  }
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class FineTuneReinforcementHyperparametersBatchSizeUnionVariantString extends FineTuneReinforcementHyperparametersBatchSizeUnion with FineTuneReinforcementHyperparametersBatchSizeUnionVariantStringMappable {
  final String value;

  const FineTuneReinforcementHyperparametersBatchSizeUnionVariantString({
    required this.value,
  });
}

@MappableClass(ignoreNull: true, includeTypeId: false)
class FineTuneReinforcementHyperparametersBatchSizeUnionVariantInt extends FineTuneReinforcementHyperparametersBatchSizeUnion with FineTuneReinforcementHyperparametersBatchSizeUnionVariantIntMappable {
  final int value;

  const FineTuneReinforcementHyperparametersBatchSizeUnionVariantInt({
    required this.value,
  });
}
...
extension FineTuneReinforcementHyperparametersBatchSizeUnionJsonValue on FineTuneReinforcementHyperparametersBatchSizeUnion {
...
class FineTuneReinforcementHyperparametersBatchSizeUnionHook extends MappingHook {
  ...
  Object? beforeDecode(Object? value) {
    ...
    if (value != null && value is! FineTuneReinforcementHyperparametersBatchSizeUnion && value is! Map<String, dynamic>) {
