...
enum RealtimeSessionCreateRequestGaModelUnionEnum {
  ...
  static List<RealtimeSessionCreateRequestGaModelUnionEnum> get $valuesDefined => values.where((value) => value != RealtimeSessionCreateRequestGaModelUnionEnum.unknown).toList();
}
