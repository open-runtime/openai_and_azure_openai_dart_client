...
class RealtimeMcpProtocolError extends RealtimeMcpToolCallErrorUnion with RealtimeMcpProtocolErrorMappable {
  const RealtimeMcpProtocolError({required this.type, required this.code, required this.message});
