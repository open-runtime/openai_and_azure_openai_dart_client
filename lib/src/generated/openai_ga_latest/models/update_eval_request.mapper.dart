...
class UpdateEvalRequestMapper extends ClassMapperBase<UpdateEvalRequest> {
  ...
  static Metadata? _$metadata(UpdateEvalRequest v) => v.metadata;
  static const Field<UpdateEvalRequest, Metadata> _f$metadata = Field(
    'metadata',
    _$metadata,
    opt: true,
  );
...
>
  ...
  $R call({String? name, Metadata? metadata});
