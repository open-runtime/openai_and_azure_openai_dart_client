...
class CreateThreadAndRunRequestMapper
  ...
  static List<AssistantTool>? _$tools(CreateThreadAndRunRequest v) => v.tools;
  static const Field<CreateThreadAndRunRequest, List<AssistantTool>> _f$tools =
  ...
  static const Field<CreateThreadAndRunRequest, Metadata> _f$metadata = Field(
    'metadata',
    _$metadata,
    opt: true,
  );
  ...
  static const Field<CreateThreadAndRunRequest, AssistantsApiToolChoiceOption>
  _f$toolChoice = Field(
    'toolChoice',
    _$toolChoice,
    key: r'tool_choice',
  ...
  static bool? _$parallelToolCalls(CreateThreadAndRunRequest v) =>
      v.parallelToolCalls;
  static const Field<CreateThreadAndRunRequest, bool> _f$parallelToolCalls =
      Field(
        'parallelToolCalls',
        _$parallelToolCalls,
