...
class DeleteCertificateResponseMapper
  ...
  static dynamic _$objectField(DeleteCertificateResponse v) => v.objectField;
  static const Field<DeleteCertificateResponse, dynamic> _f$objectField = Field(
    'objectField',
    _$objectField,
    key: r'object',
  );
...
>
  ...
  $R call({dynamic objectField, String? id});
...
class _DeleteCertificateResponseCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Object? objectField = $none, String? id}) => $apply(
    FieldCopyWithData({
