...
part 'realtime_session_model.mapper.dart';
...
enum RealtimeSessionModel {
  ...
  static List<RealtimeSessionModel> get $valuesDefined => values.where((value) => value != RealtimeSessionModel.unknown).toList();
}
