...
class CreateRunRequestMapper extends ClassMapperBase<CreateRunRequest> {
  ...
  static List<AssistantTool>? _$tools(CreateRunRequest v) => v.tools;
  static const Field<CreateRunRequest, List<AssistantTool>> _f$tools = Field(
    'tools',
    _$tools,
    opt: true,
  );
  static Metadata? _$metadata(CreateRunRequest v) => v.metadata;
  static const Field<CreateRunRequest, Metadata> _f$metadata = Field(
    'metadata',
    _$metadata,
    opt: true,
  );
