...
class VectorStoreFileObjectMapper
  ...
  _f$lastError = Field('lastError', _$lastError, key: r'last_error');
  static ChunkingStrategyResponseUnion? _$chunkingStrategy(
    VectorStoreFileObject v,
  ) => v.chunkingStrategy;
  static const Field<VectorStoreFileObject, ChunkingStrategyResponseUnion>
  ...
  static VectorStoreFileAttributes? _$attributes(VectorStoreFileObject v) =>
      v.attributes;
  static const Field<VectorStoreFileObject, VectorStoreFileAttributes>
