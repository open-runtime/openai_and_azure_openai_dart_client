...
part 'realtime_session_model_model.mapper.dart';

/// The Realtime model used for this session.
///
@MappableEnum(defaultValue: 'unknown')
enum RealtimeSessionModelModel {
  ...
  static List<RealtimeSessionModelModel> get $valuesDefined => values.where((value) => value != RealtimeSessionModelModel.unknown).toList();
}
