...
class CreateChatCompletionStreamResponseChoicesLogprobs with CreateChatCompletionStreamResponseChoicesLogprobsMappable {
  const CreateChatCompletionStreamResponseChoicesLogprobs({required this.content, required this.refusal});

  final List<ChatCompletionTokenLogprob>? content;
  final List<ChatCompletionTokenLogprob>? refusal;

  static CreateChatCompletionStreamResponseChoicesLogprobs fromJson(Map<String, dynamic> json) =>
      CreateChatCompletionStreamResponseChoicesLogprobsMapper.fromJson(json);
}
