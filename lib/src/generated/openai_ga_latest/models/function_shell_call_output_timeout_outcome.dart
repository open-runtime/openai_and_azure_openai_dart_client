...
class FunctionShellCallOutputTimeoutOutcome extends FunctionShellCallOutputContentOutcomeUnion
    with FunctionShellCallOutputTimeoutOutcomeMappable {
  const FunctionShellCallOutputTimeoutOutcome({this.type = FunctionShellCallOutputTimeoutOutcomeType.timeout});

  final FunctionShellCallOutputTimeoutOutcomeType type;

  static FunctionShellCallOutputTimeoutOutcome fromJson(Map<String, dynamic> json) =>
