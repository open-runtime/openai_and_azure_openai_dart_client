...
class ModifyThreadRequestMapper extends ClassMapperBase<ModifyThreadRequest> {
  ...
  static ModifyThreadRequestToolResources? _$toolResources(
  ...
  static Metadata? _$metadata(ModifyThreadRequest v) => v.metadata;
  static const Field<ModifyThreadRequest, Metadata> _f$metadata = Field(
    'metadata',
    _$metadata,
    opt: true,
  );
...
class _ModifyThreadRequestCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Object? toolResources = $none, Object? metadata = $none}) => $apply(
    FieldCopyWithData({
