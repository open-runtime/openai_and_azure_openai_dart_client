...
class CreateCompletionRequestMapper
  ...
  static StopConfiguration? _$stop(CreateCompletionRequest v) => v.stop;
  static const Field<CreateCompletionRequest, StopConfiguration> _f$stop =
      Field('stop', _$stop, opt: true);
  static ChatCompletionStreamOptionsUnion? _$streamOptions(
    CreateCompletionRequest v,
  ) => v.streamOptions;
  static const Field<CreateCompletionRequest, ChatCompletionStreamOptionsUnion>
