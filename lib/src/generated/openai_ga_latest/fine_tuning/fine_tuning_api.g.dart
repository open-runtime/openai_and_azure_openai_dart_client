...
class _FineTuningApi implements FineTuningApi {
  ...
  @override
  Future<HttpResponse<RunGraderResponse>> runGrader({
    ...
    late RunGraderResponse _value;
    try {
      _value = RunGraderResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<HttpResponse<ValidateGraderResponse>> validateGrader({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ValidateGraderResponse _value;
    try {
      _value = ValidateGraderResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<HttpResponse<FineTuningJob>> pauseFineTuningJob({
    required String fineTuningJobId,
    Map<String, dynamic>? extras,
    RequestOptions? options,
  }) async {
  ...
  @override
  Future<HttpResponse<FineTuningJob>> resumeFineTuningJob({
    required String fineTuningJobId,
    Map<String, dynamic>? extras,
    RequestOptions? options,
  }) async {
