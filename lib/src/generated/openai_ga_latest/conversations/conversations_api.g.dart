...
part of 'conversations_api.dart';
...
class _ConversationsApi implements ConversationsApi {
  _ConversationsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<ConversationItemList>> createConversationItems({
    ...
    late ConversationItemList _value;
    try {
      _value = ConversationItemList.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<ConversationItem>> getConversationItem({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ConversationItem _value;
    try {
      _value = ConversationItem.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<HttpResponse<ConversationResource>> deleteConversationItem({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ConversationResource _value;
    try {
      _value = ConversationResource.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<HttpResponse<DeletedConversationResource>> deleteConversation({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeletedConversationResource _value;
    try {
      _value = DeletedConversationResource.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
