...
abstract class VectorStoresApi {
  ...
  Future<HttpResponse<ListVectorStoreFilesResponse>> listFilesInVectorStoreBatch({
    @Path('vector_store_id') required String vectorStoreId,
    @Path('batch_id') required String batchId,
    @Query('after') String? after,
    @Query('before') String? before,
  ...
  Future<HttpResponse<VectorStoreFileObject>> updateVectorStoreFileAttributes({
    @Path('vector_store_id') required String vectorStoreId,
    @Path('file_id') required String fileId,
    @Body() required UpdateVectorStoreFileAttributesRequest body,
    @Extras() Map<String, dynamic>? extras,
    @DioOptions() RequestOptions? options,
  });
  ...
  Future<HttpResponse<VectorStoreFileContentResponse>> retrieveVectorStoreFileContent({
    @Path('vector_store_id') required String vectorStoreId,
    @Path('file_id') required String fileId,
    @Extras() Map<String, dynamic>? extras,
    @DioOptions() RequestOptions? options,
  ...
  Future<HttpResponse<VectorStoreSearchResultsPage>> searchVectorStore({
    @Path('vector_store_id') required String vectorStoreId,
    @Body() required VectorStoreSearchRequest body,
    @Extras() Map<String, dynamic>? extras,
    @DioOptions() RequestOptions? options,
  });
}
