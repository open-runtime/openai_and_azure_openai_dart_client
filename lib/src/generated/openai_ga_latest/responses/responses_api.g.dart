...
class _ResponsesApi implements ResponsesApi {
  _ResponsesApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<ResponseModel>> getResponse({
    ...
    final queryParameters = <String, dynamic>{
      r'include': include,
      r'stream': stream,
      r'starting_after': startingAfter,
      r'include_obfuscation': includeObfuscation,
    };
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
