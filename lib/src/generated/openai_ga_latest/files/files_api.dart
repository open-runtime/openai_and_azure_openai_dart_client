...
import '../models/file_expiration_after.dart';
import '../models/file_purpose.dart';
...
abstract class FilesApi {
  ...
  Future<HttpResponse<OpenAiFile>> createFile({
    ...
    @Part(name: 'purpose') required FilePurpose purpose,
    @Part(name: 'expires_after') FileExpirationAfter? expiresAfter,
    @Extras() Map<String, dynamic>? extras,
    @DioOptions() RequestOptions? options,
  });
