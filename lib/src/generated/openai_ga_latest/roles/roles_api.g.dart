...
class _RolesApi implements RolesApi {
  _RolesApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<PublicRoleListResource>> listRoles({
    ...
    late PublicRoleListResource _value;
    try {
      _value = PublicRoleListResource.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<Role>> createRole({
    ...
    late Role _value;
    try {
      _value = Role.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<HttpResponse<RoleDeletedResource>> deleteRole({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RoleDeletedResource _value;
    try {
      _value = RoleDeletedResource.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
