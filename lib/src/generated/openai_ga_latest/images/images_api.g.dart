...
class _ImagesApi implements ImagesApi {
  ...
  Future<HttpResponse<ImagesResponse>> createImageEdit({
    ...
    if (background != null) {
      _data.fields.add(MapEntry('background', background.toJson()));
    }
    if (n != null) {
    ...
    if (outputFormat != null) {
      _data.fields.add(MapEntry('output_format', outputFormat.toJson()));
    }
    if (outputCompression != null) {
      _data.fields.add(
        MapEntry('output_compression', outputCompression.toString()),
      );
    }
    if (stream != null) {
    ...
    if (inputFidelity != null) {
      _data.fields.add(MapEntry('input_fidelity', inputFidelity.toJson()));
    }
    _data.fields.add(
      MapEntry(
        'partial_images',
        jsonEncode(partialImages ?? <String, dynamic>{}),
      ),
    );
