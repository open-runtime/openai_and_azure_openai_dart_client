...
class InputImage extends InputContent with InputImageMappable {
  const InputImage({required this.type, this.detail = InputImageDetail.auto, this.imageUrl, this.fileId});
