...
extension AzureSearchChatExtensionParametersAuthenticationAuthenticationUnionDeserializer on AzureSearchChatExtensionParametersAuthenticationAuthenticationUnion {
  static AzureSearchChatExtensionParametersAuthenticationAuthenticationUnion tryDeserialize(Map<String, dynamic> json) {
    ...
    try {
      return AzureSearchChatExtensionParametersAuthenticationAuthenticationUnionOnYourDataAccessTokenAuthenticationOptionsMapper.fromJson(json);
    } catch (_) {}
...
@MappableClass()
class AzureSearchChatExtensionParametersAuthenticationAuthenticationUnionOnYourDataAccessTokenAuthenticationOptions extends AzureSearchChatExtensionParametersAuthenticationAuthenticationUnion with AzureSearchChatExtensionParametersAuthenticationAuthenticationUnionOnYourDataAccessTokenAuthenticationOptionsMappable {


  const AzureSearchChatExtensionParametersAuthenticationAuthenticationUnionOnYourDataAccessTokenAuthenticationOptions();
}
