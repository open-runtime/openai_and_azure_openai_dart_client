...
enum CreateChatCompletionRequestReasoningEffortReasoningEffort {
  ...
  static List<CreateChatCompletionRequestReasoningEffortReasoningEffort> get $valuesDefined => values.where((value) => value != CreateChatCompletionRequestReasoningEffortReasoningEffort.unknown).toList();
}
