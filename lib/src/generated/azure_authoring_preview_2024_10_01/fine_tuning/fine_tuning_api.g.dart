...
class _FineTuningApi implements FineTuningApi {
  ...
  Future<HttpResponse<FineTuningJobList>> fineTuningList({
    ...
    late FineTuningJobList _value;
    try {
      _value = FineTuningJobList.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<FineTuningJob>> fineTuningCreate({
    required FineTuningJobCreation fineTuningJob,
    String? apiVersion,
    Map<String, dynamic>? extras,
    RequestOptions? options,
  }) async {
    ...
    _data.addAll(fineTuningJob.toJson());
    final newOptions = newRequestOptions(options);
    newOptions.extra.addAll(_extra);
    newOptions.headers.addAll(_dio.options.headers);
    newOptions.headers.addAll(_headers);
  ...
  Future<HttpResponse<FineTuningJobCheckpointList>> fineTuningGetCheckpoints({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FineTuningJobCheckpointList _value;
    try {
      _value = FineTuningJobCheckpointList.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<HttpResponse<FineTuningJobEventList>> fineTuningGetEvents({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FineTuningJobEventList _value;
    try {
      _value = FineTuningJobEventList.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
