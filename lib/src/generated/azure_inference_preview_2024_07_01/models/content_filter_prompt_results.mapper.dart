...
class ContentFilterPromptResultsMapper
  ...
  static const Field<ContentFilterPromptResults, ContentFilterDetailedResults>
  ...
  static ContentFilterDetectedResult? _$indirectAttack(
    ContentFilterPromptResults v,
  ) => v.indirectAttack;
  static const Field<ContentFilterPromptResults, ContentFilterDetectedResult>
  _f$indirectAttack = Field(
    'indirectAttack',
    _$indirectAttack,
    key: r'indirect_attack',
    opt: true,
  );
  ...
  final MappableFields<ContentFilterPromptResults> fields = const {
    ...
    #indirectAttack: _f$indirectAttack,
  };
  ...
  static ContentFilterPromptResults _instantiate(DecodingData data) {
    return ContentFilterPromptResults(
      ...
      indirectAttack: data.dec(_f$indirectAttack),
    );
  }
...
>
  ...
  $R call({
    ...
    ContentFilterDetectedResult? indirectAttack,
  });
...
class _ContentFilterPromptResultsCopyWithImpl<$R, $Out>
  ...
  >?
  get indirectAttack =>
      $value.indirectAttack?.copyWith.$chain((v) => call(indirectAttack: v));
  @override
  $R call({
    Object? sexual = $none,
    ...
    FieldCopyWithData({
      ...
      if (indirectAttack != $none) #indirectAttack: indirectAttack,
    }),
  );
  @override
  ContentFilterPromptResults $make(CopyWithData data) =>
      ContentFilterPromptResults(
        ...
        indirectAttack: data.get(#indirectAttack, or: $value.indirectAttack),
      );
