...
class OnYourDataUserAssignedManagedIdentityAuthenticationOptions
    with OnYourDataUserAssignedManagedIdentityAuthenticationOptionsMappable {
  ...
  static OnYourDataUserAssignedManagedIdentityAuthenticationOptions fromJson(Map<String, dynamic> json) =>
      OnYourDataUserAssignedManagedIdentityAuthenticationOptionsMapper.fromJson(json);
}
