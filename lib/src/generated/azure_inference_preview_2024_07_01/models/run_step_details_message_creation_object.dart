...
class RunStepDetailsMessageCreationObject extends RunStepObjectStepDetailsUnion
    with RunStepDetailsMessageCreationObjectMappable {
  ...
  static RunStepDetailsMessageCreationObject fromJson(Map<String, dynamic> json) =>
