...
class EmbeddingsCreateRequestMapper
  ...
  static String? _$encodingFormat(EmbeddingsCreateRequest v) =>
      v.encodingFormat;
  static const Field<EmbeddingsCreateRequest, String> _f$encodingFormat = Field(
    'encodingFormat',
    _$encodingFormat,
    key: r'encoding_format',
    opt: true,
  );
  static int? _$dimensions(EmbeddingsCreateRequest v) => v.dimensions;
  static const Field<EmbeddingsCreateRequest, int> _f$dimensions = Field(
    'dimensions',
    _$dimensions,
    opt: true,
  );
...
class _EmbeddingsCreateRequestCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (encodingFormat != $none) #encodingFormat: encodingFormat,
