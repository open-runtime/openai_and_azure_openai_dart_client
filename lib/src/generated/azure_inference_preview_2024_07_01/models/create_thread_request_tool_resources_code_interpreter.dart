...
class CreateThreadRequestToolResourcesCodeInterpreter with CreateThreadRequestToolResourcesCodeInterpreterMappable {
  ...
  static CreateThreadRequestToolResourcesCodeInterpreter fromJson(Map<String, dynamic> json) => CreateThreadRequestToolResourcesCodeInterpreterMapper.fromJson(json);
