...
## [0.1.2](https://github.com/open-runtime/openai_and_azure_openai_dart_client/compare/v0.1.1...v0.1.2) (2025-12-02)


### Tests

* update tests to use fixed enum names after generator improvements ([dc5daf1](https://github.com/open-runtime/openai_and_azure_openai_dart_client/commit/dc5daf1671875273cb9cd4b58a3dcd2701d00243))
